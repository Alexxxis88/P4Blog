    ...
    <div class="row chapterStatsRow">     
        <div class="col-md-4" >
            <div class="bestChaptUser">
                ...
                <a href="index.php?action=post&id=<?= $rankingBestPost['id']?>&page=1&sortBy=5"><i class="far fa-eye"></i>  Voir le chapitre</a>
            </div>
            ...
            <div class="worstChaptUser">
                ...
                <a href="index.php?action=post&id=<?= $rankingWorstPost['id']?>&page=1&sortBy=5"><i class="far fa-eye"></i>  Voir le chapitre</a>
            </div>
        </div>
        <div class="col-md-8">
